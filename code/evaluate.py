...
def main ():
    ...
    def callback (feature_key, y_pred, model_metadata):
        ...
        if task_type == 'regression':
            y_real = dataset.get ()['label'].fillna (0)
        else:
        ...
        cm = sklearn.metrics.confusion_matrix (y_true = y_real, y_pred = y_pred, labels = labels, normalize = 'true') if y_real_labels_available else None
