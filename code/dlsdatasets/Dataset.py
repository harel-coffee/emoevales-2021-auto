...
class Dataset ():
    ...
    def assign_default_splits (self, df):
    ...
    def get_num_labels (self):
        ...
        return len (self.df.loc[self.df['__split'] == 'train']['label'].dropna ().unique ()) if self.get_task_type () == 'classification' else 1
    ...
    def get_available_labels (self):
        ...
        return sorted (self.df.loc[self.df['__split'] == 'train'].loc[self.df['label'].notna()]['label'].unique ())
